...
2. Press ctrl + s, and remove the .txt from the end of the file name
...
# How to use:
1. Launch the .bat
2. Drag and drop the FOLDER that contains your code and main.lua
3. Type in a name for the program
4. And now you have a .zip containing all the necessary .dll files and your .exe file!!
